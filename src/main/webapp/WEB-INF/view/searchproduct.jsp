...
<html>
<head>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/searchproduct.css" type="text/css"/>
    <title>Search</title>
</head>
<body>
    <div id="head">
                            ...
                            <div class="page-item">
                                ...
                                <c:choose>
                                    <c:when test="${productPage.number ==0}">
                                        <a class="page-link" href="searchProduct?searchproduct=${searchproduct}&page=0">&lsaquo;</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="page-link" href="searchProduct?searchproduct=${searchproduct}&page=${productPage.number-1}">&lsaquo;</a>
                                    </c:otherwise>
                                </c:choose>

                                <c:choose>
                                    <c:when test="${productPage.number ==productPage.totalPages-1}">
                                        <a class="page-link" href="searchProduct?searchproduct=${searchproduct}&page=${productPage.totalPages-1}">&rsaquo;</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="page-link" href="searchProduct?searchproduct=${searchproduct}&page=${productPage.number+1}">&rsaquo;</a>
                                    </c:otherwise>
                                </c:choose>
