        ...
        <div class="product">
            <div class="b-color">
                <div class="form-size-product">
                    <div class="size-product">Hiện có ${sizeByMoney} Điện thoại</div>
                </div>
                <div class="row-p">
                    ...
                    <c:if test="${sizeByMoney > 8}">
                        <nav class="home-page" aria-label="Page navigation example">
                            <div class="page-item">
                                <a class="page-link" href="searchByMoney?searchByMoney=${searchByMoney}&page=0">&laquo;</a>
                                <c:choose>
                                    <c:when test="${productPage.number ==0}">
                                        <a class="page-link" href="searchByMoney?searchByMoney=${searchByMoney}&page=0">&lsaquo;</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="page-link" href="searchByMoney?searchByMoney=${searchByMoney}&page=${productPage.number-1}">&lsaquo;</a>
                                    </c:otherwise>
                                </c:choose>

                                <c:choose>
                                    <c:when test="${productPage.number ==productPage.totalPages-1}">
                                        <a class="page-link" href="searchByMoney?searchByMoney=${searchByMoney}&page=${productPage.totalPages-1}">&rsaquo;</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a class="page-link" href="searchByMoney?searchByMoney=${searchByMoney}&page=${productPage.number+1}">&rsaquo;</a>
                                    </c:otherwise>
                                </c:choose>
                                <a class="page-link" href="searchByMoney?searchByMoney=${searchByMoney}&page=${productPage.totalPages-1}">&raquo;</a>
                            </div>
                        </nav>
                    </c:if>
                </div>
