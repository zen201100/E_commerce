...
<html>
<head>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/styleproduct.css" type="text/css"/>
    <title>Product</title>
</head>
<body>
    <div id="head">
                    ...
                    <nav class="home-page" aria-label="Page navigation example">
                        <div class="page-item">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a class="page-link" href="product?page=${productPage.number-1}">&lsaquo;</a>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a class="page-link" href="product?page=${productPage.number+1}">&rsaquo;</a>
                                </c:otherwise>
                            </c:choose>
